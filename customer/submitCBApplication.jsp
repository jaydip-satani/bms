...
<%
    ...
    try {
        ...
        String sql = "INSERT INTO cheque_book_requests (user_id, account_id, contact_number, status) VALUES (?, ?, ?,  'pending')";
        ...
        if (rowsInserted > 0) {
            out.println("<script>alert('Cheque Book Application Submitted Successfully!'); window.location.href='customerDashboard.jsp';</script>");
        } else {
